...
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Instructor','truman', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Truman', 'Willis', 'isamarkomarkovic99@gmail.com', '305-555-0163',1,true,'1983-07-12 21:30:55.888');
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Instructor','raymond', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Raymond', 'Weaving', 'isamarkomarkovic99@gmail.com', '305-555-0720',2,true,'1983-07-12 21:30:55.888');
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Instructor','stewart', '222', 'Stewart', 'Lindsey', 'isamarkomarkovic99@gmail.com', '305-555-0000',3,true,'1983-07-12 21:30:55.888');
insert into app_user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Instructor','bruno', '333', 'Bruno', 'Nicholson', 'isamarkomarkovic99@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888');
insert into app_user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Client','ana', '$2a$10$qELfQNNCVvxVYgDYv4XUue6QIJ2ca09BFPPC3/M9Ke6q8PqRLkvdy', 'Ana', 'Anic', 'isamarkomarkovic99@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888');
insert into app_user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Instructor','lana', '$2a$10$PTOW/.r9dgjokBc60GGnIO6csC4ReF7ql/F21IE/spO4fhCQLP9XK', 'Lana', 'Laic', 'isamarkomarkovic99@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888');
insert into app_user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Client','laza', '$2a$10$sfvnEaK0mFaQB1VH3b.5k.ZloVuTXQ4DmM/uJazZNWh8.gcMa/2Bi', 'Laza', 'Anic', 'isamarkomarkovic99@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888');
insert into app_user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Client','dusko', '$2a$10$sfvnEaK0mFaQB1VH3b.5k.ZloVuTXQ4DmM/uJazZNWh8.gcMa/2Bi', 'Dusko', 'Dusic', 'isamarkomarkovic99@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888');
insert into app_user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Client','daca', '$2a$10$sfvnEaK0mFaQB1VH3b.5k.ZloVuTXQ4DmM/uJazZNWh8.gcMa/2Bi', 'Danica', 'Danicic', 'isamarkomarkovic99@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888');
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('SysAdmin','taylor', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Taylor', 'Smith', 'isamarkomarkovic99@gmail.com', '305-666-0163',3,true,'1983-07-12 21:30:55.888');
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('CottageOwner','anna', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Ana', 'Popovic', 'isamarkomarkovic99@gmail.com', '305-555-0163',1,true,'1983-07-12 21:30:55.888');
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Client','Maya', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Maya', 'Smith', 'isamarkomarkovic99@gmail.com', '305-555-0163',5,true,'1983-07-12 21:30:55.888');
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Instructor','tanya', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Tanya', 'Smith', 'isamarkomarkovic99@gmail.com', '305-555-0163',5,false,'1983-07-12 21:30:55.888');
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Cottage Owner','sam', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Sam', 'Smith', 'isamarkomarkovic99@gmail.com', '305-555-0163',5,false,'1983-07-12 21:30:55.888');
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('BoatOwner','aleks', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Aleks', 'Willis', 'isamarkomarkovic99@gmail.com', '305-555-0163',3,true,'1983-07-12 21:30:55.888');
...
values ('Lucky B Sportfishing','Lucky B Sportfishing welcomes you to one of the most beautiful fisheries in the world. This charter service is operated by a professional crew that always strives to exceed their guests’ expectations',5.0,100,10,'/assets/adventure/Adventure1.jpg',1,1,0);
insert into adventure(name,description,average_grade,price,max_persons,main_picture,address_id,instructor_id,cancellation_percentage) 
values('The Long Run Sportfishing','No matter what kind of fishing trip you’re looking for, The Long Run is at your disposal. She’s a 40’ Hershine boat that’s got plenty of room for up to 6 anglers to be fishing in comfort.',0,80,7,'/assets/adventure/Adventure2.jpg',2,1,10); 
insert into adventure(name,description,average_grade,price,max_persons,main_picture,address_id,instructor_id,cancellation_percentage) 
values ('Reel Floridian Fishing','Head out to some of the richest waters of the mighty Atlantic as you search for some trophy specimens.',0,250,5,'/assets/adventure/Adventure3.jpg',10,1,15);
insert into adventure(name,description,average_grade,price,max_persons,main_picture,address_id,instructor_id,cancellation_percentage) 
values ('Fishing river','Head out to some of the richest waters of the mighty Atlantic as you search for some trophy specimens.',0,250,5,'/assets/adventure/Adventure5.jpg',1,2,15);
insert into adventure(name,description,average_grade,price,max_persons,main_picture,address_id,instructor_id,cancellation_percentage) 
values ('Super star fishing','Head out to some of the richest waters of the mighty Atlantic as you search for some trophy specimens.',0,415,8,'/assets/adventure/Adventure4.jpg',5,1,20);
...
insert into adventure_reservation(reservation_start,reservation_end,number_of_persons,price,adventure_id,client_id,system_earning) values('2023-7-10 07:00:00','2023-7-12 13:00:00',3,5400,1,8,540); 
insert into adventure_reservation(reservation_start,reservation_end,number_of_persons,price,adventure_id,client_id,system_earning) values('2021-8-10 07:00:00','2021-8-12 13:00:00',3,3000,1,5,300); 
