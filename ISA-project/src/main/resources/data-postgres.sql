...
insert into app_user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date,deleted) values ('Client','ana', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Ana', 'Anic', 'isa.booking22@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888',false);
...
insert into app_user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date,deleted) values ('Client','dusko', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Dusko', 'Dusic', 'isa.booking22@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888',false);
insert into app_user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date,deleted) values ('Client','daca', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Danica', 'Danicic', 'isa.booking22@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888',false);
...
insert into app_user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date,deleted) values ('BoatOwner','naomi', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Naomi', 'Willis', 'isa.booking22@gmail.com', '305-555-0163',3,true,'1983-07-12 21:30:55.888',false);
...
insert into instructor (id,biography,grade) values (1,'I was born and raised in Key West',3);
insert into instructor (id,biography,grade) values (2,'Being on the water beautiful water can make memories.',4);
insert into instructor (id,biography,grade) values (3,'I was born and raised in Key West',3);
insert into instructor (id,biography,grade) values (4,'I was born and raised in Key West',5);
insert into instructor (id,biography,grade) values (6,'I was born and raised in Key West',2);
...
values ('Lucky B Sportfishing','Lucky B Sportfishing welcomes you to one of the most beautiful fisheries in the world',5.0,100,10,'/assets/adventure/Adventure1.jpg',1,1,0,false);
insert into adventure(name,description,average_grade,price,max_persons,main_picture,address_id,instructor_id,cancellation_percentage,deleted) 
values('The Long Run Sportfishing','No matter what kind of fishing trip you’re looking for, The Long Run is at your disposal. She’s a 40',9,80,7,'/assets/adventure/Adventure2.jpg',2,1,10,false); 
insert into adventure(name,description,average_grade,price,max_persons,main_picture,address_id,instructor_id,cancellation_percentage,deleted) 
values ('Reel Floridian Fishing','Head out to some of the richest waters of the mighty Atlantic',7,250,5,'/assets/adventure/Adventure3.jpg',10,1,15,false);
insert into adventure(name,description,average_grade,price,max_persons,main_picture,address_id,instructor_id,cancellation_percentage,deleted) 
...
insert into adventure(name,description,average_grade,price,max_persons,main_picture,address_id,instructor_id,cancellation_percentage,deleted) 
values ('Super star fishing','Head out to some of the richest waters of the mighty',0,415,8,'/assets/adventure/Adventure4.jpg',5,1,20,false);
...
insert into cottage_fast_reservation(reservation_start,reservation_end,date,time,duration,validity_start,validity_end,max_persons,price,cottage_id) values ('2022-09-20-10-00-00','2022-09-27-16-00-00',"2021-12-10T06:30:00","06:30:00",3,'2022-12-10','2022-12-14',4,460,2);
...
insert into cottage_reservation(date,duration,max_persons,price,client_id,cottage_id,reservation_start,reservation_end,system_earning,deleted) values ("2016-02-20T06:30:00",10,10,15000,5,1,'2022-08-10-10-00-00','2022-08-15-16-00-00',20,false);
insert into cottage_reservation(date,duration,max_persons,price,client_id,cottage_id,reservation_start,reservation_end,system_earning,deleted) values ("2014-02-20T06:30:00",3,2,7000,8,2,'2022-08-02-10-00-00','2022-08-09-16-00-00',30,false);
