...
insert into user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Client','ana', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Ana', 'Anic', 'isamarkomarkovic99@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888');
...
insert into user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Client','dusko', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Dusko', 'Dusic', 'isamarkomarkovic99@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888');
insert into user ( role,username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('Client','daca', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Danica', 'Danicic', 'isamarkomarkovic99@gmail.com', '305-555-0419',4,true,'1983-07-12 21:30:55.888');
...
insert into user (role, username, password, first_name, last_name, email, mobile,address_id,enabled,last_password_reset_date) values ('CottageOwner','anna', '$2a$04$Vbug2lwwJGrvUXTj6z7ff.97IzVBkrJ1XfApfGNl.Z695zqcnPYra', 'Ana', 'Popovic', 'isamarkomarkovic99@gmail.com', '305-555-0163',1,true,'1983-07-12 21:30:55.888');
