...
@Entity
public class BoatOwnerRevision {
	@Id
	...
	public BoatOwnerRevision(Long id, BoatReservation boatReservation, Revision revision) {
		super();
		this.id = id;
		this.boatReservation = boatReservation;
		this.revision = revision;
	...
	public BoatOwnerRevision(BoatReservation boatReservation, Revision revision) {
		this.boatReservation = boatReservation;
		this.revision = revision;
	}
}
